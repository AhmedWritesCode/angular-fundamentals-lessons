...
// The [] Brackets are what determine that the right size  is an expression not a string
@Component({
  selector: 'app-root',
  standalone: true,
  template: `
    ...
    <section class="container">
      @for (carEntry of carList; track carEntry) {
        <app-listing [car]="carEntry" (carSaved)="addCarToSaved($event)"/> // $event is a placeholder for the emitted value
      }
    </section>
    <article>
